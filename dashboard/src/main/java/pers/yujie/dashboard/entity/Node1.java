...
@Data
public class Node1 extends DynamicStruct {

  public Node1(Utf8String clusterName, Utf8String name, Bool isOnline, Uint256 usedSpace,
      Uint256 totalSpace) {
  ...
  public Node1(String clusterName, String name, boolean isOnline, BigInteger usedSpace,
